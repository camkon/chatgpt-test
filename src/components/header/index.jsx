...
const Header = ({page, setPage}) => {
  return (
    <Box sx={{position: 'sticky', top: '0', zIndex: 100, height: '3.8rem', width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', columnGap: '1rem', borderBottom: '1px solid #2a2b32', background: '#343541'}}>
        <Box sx={{display: 'flex', alignItems: 'center', justifyContent: 'center', columnGap: '0.25rem', background: '#202123', padding: '0.25rem', borderRadius: '0.5rem', color: '#ececf1', maxWidth: '90vw', margin: '0 0.5rem'}}>
